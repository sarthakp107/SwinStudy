...
export const ViewAllGeneratedFlashcards = () =>{    
    ...
    const count = allGeneratedFlashcards.length
    ...
    {count > 0 && allGeneratedFlashcards[current_question] ? (
        // Main Div
        <div className="min-h-screen bg-gray-50 py-12 px-6 flex flex-col items-center">
            ...
            <div className="w-full max-w-3xl mx-auto bg-white rounded-2xl shadow-2xl p-10">
                <Flashcard question={allGeneratedFlashcards[current_question].question} answer={allGeneratedFlashcards[current_question].answer}/>
